<template>
            ...
            <div class="rounded-0 bg-[#ffffff] shadow-xl md:w-[250px] lg:w-full">
                ...
                <div class="flex flex-col p-8 space-y-3">
                    ...
                    <div class="flex">
                      ...
                      <div class="text-md">
                          <a href="https://wa.me/message/OAFM6LL5JZIVF1" target="_blank" class="hover:text-cyan-500">+6281290753585</a>
                      </div>
                    </div>
                </div>
            </div>
      ...
      <a href="https://wa.me/message/OAFM6LL5JZIVF1" target="_blank" class="fixed bottom-10 right-10 w-16 h-16 rounded-full bg-green-500 text-white flex justify-center items-center shadow-md hover:shadow-lg">
